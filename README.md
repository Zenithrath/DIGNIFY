...
3. `https://dignify.my.id` as the local fallback.
...
Next.js metadata is defined in each root layout and public route. It includes canonical URLs, hreflang language alternates, page descriptions, authorship, Open Graph data, Twitter cards, and a generated Open Graph image.
