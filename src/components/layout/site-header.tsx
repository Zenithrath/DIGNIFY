    ...
    <header id="top" className="sticky top-0 z-40 border-b border-line bg-paper">
      ...
      <AnimatePresence>
        {open ? (
          ...
          >
            <Container className="flex h-16 items-center justify-end border-b border-line-dark">
              <button
                ref={closeRef}
                type="button"
            ...
            <div className="border-t border-line-dark px-5 py-5">
              ...
              <a
                ...
                className="mt-2 inline-block text-sm text-paper underline decoration-paper/40 underline-offset-4 transition-colors hover:text-gold hover:decoration-gold"
              >
                {site.email}
              </a>
            </div>
