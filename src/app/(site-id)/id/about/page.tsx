                ...
                <article className="flex h-full flex-col border border-line bg-pure p-6 sm:p-8">
                  ...
                  <ul className="mt-5 flex flex-wrap gap-2">
                    {member.focus.map((item) => (
                      <li key={item} className="meta-label border border-line px-2 py-1 text-muted">
                        {item}
                      </li>
                    ))}
                  </ul>
                  <p className="mt-5 text-sm leading-relaxed text-muted">{aboutId.team.lines[member.name]}</p>
